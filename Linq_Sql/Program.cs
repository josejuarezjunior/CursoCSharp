...
namespace Linq_Sql
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Console.WriteLine("------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("Os exemplos abaixo são similares ao projeto 'Linq_Lambda', porém utilizado notação simiar à linguagem SQL!");
            Console.WriteLine("------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine();
